...
class FormResource {
	...
	const FK_MEDIA_NAME = 'field_62b91798fe981';
	const FK_MEDIA_EMAIL = 'field_62b917cdfe983';
	const FK_MEDIA_PHONE = 'field_62b917cdfe984';
	...
	const FK_MEETING_POINT_IS = 'field_62b91b5b6454f';
	const FK_QUEUE_EXTERNAL_INTERNAL = 'field_62b91d9d32f55';
	const FK_QUEUE_UNDERCOVER = 'field_62b91ea2c40ae';
	...
	const FK_TOILETS_AVAILABILITY = 'field_62b933bfde1e7';
	const FK_TOILETS_AVAILABILITY_COMMENTS = 'field_62b935f401d4b';
	const FK_SUPPLY_PORTALOOS = 'field_62b9369fd4bf5';
	const FK_WET_WEATHER_CONTINGENCY = 'field_62b937f9138a6';
	const FK_WET_WEATHER_CONTINGENCY_COMMENTS = 'field_62b939255fafe';
	...
	const FK_ADDITIONAL_FOOD_COMMUNITY = 'field_62b9205817231';
	const FK_WOULD_LIKE_TO_APPLY_FOR_VOLUNTEERS = 'field_5cac415211938';
	const FK_CONTACT_BUILDING_REPR = 'field_62b94c6289cf7';
	const FK_CONFIRM_STAFF_BUILDING = 'field_62b94215da9fc';
	const FK_BUILDING_SHOULD_BE_PRE_BOOKED = 'field_5cac43b5e7c32';
	const FK_PREBOOKED_REGULARITY = 'field_62b96643e869f';
	...
	public function __construct() {
		$this->frontend_fields = array(
			...
			self::FK_MEETING_POINT_IS,
			self::FK_QUEUE_EXTERNAL_INTERNAL,
			self::FK_QUEUE_UNDERCOVER,
			self::FK_TOUR_TIPS,
			self::FK_TOUR_TIPS_OTHER,
			self::FK_DRESS_REQUIREMENTS,
			self::FK_WHEELCHAIR_ACCESS,
			self::FK_OTHER_WHEELCHAIR_ACCESS,
			self::FK_TOILETS_AVAILABILITY,
			self::FK_TOILETS_AVAILABILITY_COMMENTS,
			self::FK_SUPPLY_PORTALOOS,
			self::FK_WET_WEATHER_CONTINGENCY,
			self::FK_WET_WEATHER_CONTINGENCY_COMMENTS,
			...
			self::FK_ADDITIONAL_FOOD_COMMUNITY,
			self::FK_WOULD_LIKE_TO_APPLY_FOR_VOLUNTEERS,
			self::FK_CONTACT_BUILDING_REPR,
			self::FK_CONFIRM_STAFF_BUILDING,
			self::FK_BUILDING_SHOULD_BE_PRE_BOOKED,
			self::FK_PREBOOKED_REGULARITY,
